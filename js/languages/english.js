export const englishLanguage = {
  ...
  TYPED_SCRIPT: {
    id: "#typed-script",
    value: "Software and Web Application Developer",
  },
  ...
  ABOUT_DESCRIPTION1: {
    ...
    value:
      "Currently working as a Trainee Software Developer at FIT - Instituto de Tecnologia, where I participate in software development using Angular, React and C#.NET, with over tree years of experience in the area. Graduated in Computer Engineering from FACENS.",
  },
  ABOUT_DESCRIPTION2: {
    id: "#about-description2",
    value:
      "One year and six months of experience in the IT area, performing in the management of activities, maintenance and mounting of equipment, Windows operating system users support, and network infrastructure maintenance and support.",
  },
  ...
  ABOUT_DEGREE_INFO: {
    ...
    value: "Degree in Computer Engineering",
  },
  ...
  RESUME_TRAINEE_FIT_DEV_DESCRIPTION: {
    ...
    value:
      "Performing tasks related to software development using C#, Angular, React and code versioning (Git), bug fixing, code review and testing, supporting the development team, monitoring the routine with agile methodologies (Scrum, Kanban) and taking part in alignment and planning meetings.",
  },
  RESUME_INTERN_DEV: {
  ...
  RESUME_INTERN_DEV_DATE: {
    ...
    value: "May/2021 - March/2023",
  },
  RESUME_INTERN_DEV_DESCRIPTION: {
    id: "#resume-intern-dev-description",
    value:
      "Performing tasks related to software development in C# and WPF languages with code versioning (Git), fixing bugs and performing tests, supporting the software development team, following the routine with agile methodologies (Scrum, Kanban) and participating in alignment and planning meetings.",
  },
  RESUME_IT_ANALYST: { id: "#resume-it-analyst", value: "IT Analyst" },
  RESUME_IT_ANALYST_DATE: {
    id: "#resume-it-analyst-date",
    value: "January/2021 - April/2021",
  },
  RESUME_IT_ANALYST_DESCRIPTION: {
    id: "#resume-it-analyst-description",
    value:
      "Windows operating system users support, server maintenance and monitoring, network infrastructure maintenance and support, budgeting for equipment purchases, equipment maintenance and mounting.",
  },
  RESUME_IT_ASSISTANT: { id: "#resume-it-assistant", value: "IT Assistant" },
  RESUME_IT_ASSISTANT_DATE: {
    id: "#resume-it-assistant-date",
    value: "February/2020 - December/2020",
  },
  RESUME_IT_ASSISTANT_DESCRIPTION: {
    id: "#resume-it-assistant-description",
    value:
      "Maintenance and mounting of equipment, Windows operating system users support, and network infrastructure maintenance and support.",
  },
  RESUME_IT_INTERN: { id: "#resume-it-intern", value: "IT Intern" },
  RESUME_IT_INTERN_DATE: {
    id: "#resume-it-intern-date",
    value: "November/2019 - January/2020",
  },
  RESUME_IT_INTERN_DESCRIPTION: {
    id: "#resume-it-intern-description",
    value:
      "Technical assistance in systems, users support, and support for the IT team.",
  },
  ...
  RESUME_CHEMICAL_ENGINEERING: {
    id: "#resume-degree-qe",
    value: "Bachelor in Chemical Engineering - FACENS",
  },
  RESUME_CHEMICAL_ENGINEERING_DATE: {
    id: "#resume-degree-qe-date",
    value: "January/2014 - December/2018",
  },
  ...
  SKILLS_FRAMEWORKS_PROGRAMING: {
    ...
    value: "Knowledge of Programming Languages and Frameworks.",
  },
  SKILLS_HTML: { id: "#skills-html", value: " - Intermediary" },
  SKILLS_CSS: { id: "#skills-css", value: " - Intermediary" },
  SKILLS_CSHARP: { id: "#skills-csharp", value: " - Intermediary" },
  SKILLS_C: { id: "#skills-c", value: " - Basic" },
  SKILLS_JS: { id: "#skills-js", value: " - Intermediary" },
  SKILLS_TYPESCRIPT: { id: "#skills-typescript", value: " - Intermediary" },
  ...
  SKILLS_REACT: { id: "#skills-react", value: " - Intermediary" },
  SKILLS_SQL: { id: "#skills-sql", value: " - Basic" },
  SKILLS_TOOL_KNOWLEDGE: {
    id: "#skills-tool-knowledge",
    value: "Knowledge in Development Tools and Methodologies.",
  },
  ...
  //Portfolio section
  PORTFOLIO_TITLE: { id: "#portfolio-title", value: "Portfolio" },
  PORTFOLIO_SUBTITLE: {
    id: "#portfolio-subtitle",
    value:
      "Projects and works made from courses, personal projects and Computer Engineering course subjects.",
  },
  PORTFOLIO_SOFTWARES: {
  ...
  PORTFOLIO_MOBILE: {
    id: "#portfolio-mobile",
    value: "-Mobile Application Projects",
  },
  ...
  CONTACTS_SUBTITLE: {
    ...
    value: "Here are my personal contacts:",
  },
...
export const englishLanguagesoft = {
  ...
  P_SOFTWARE_CONTACT_APP: {
    ...
    value: "Contact Agenda Project",
  },
  P_SOFTWARE_CONTACT_APP_DESCRIPTION: {
    id: "#software-portfolio-contactapp-description",
    value:
      "Project developed during the Windows Presentation Foundation Masterclass course, simulating a contact agenda. Applying the knowledge of WPF structures, using C#, UserControl, ListView, SQLite and style configuration.",
  },
  ...
  P_SOFTWARE_CALCULATOR: {
    ...
    value: "Basic Calculator Project",
  },
  P_SOFTWARE_CALCULATOR_DESCRIPTION: {
    id: "#software-portfolio-calculator-description",
    value:
      "Project developed during the Windows Presentation Foundation Masterclass course, simulating a basic calculator. Applying the basic knowledge of WPF structures and using C#.",
  },
  ...
  P_SOFTWARE_CHESS_DESCRIPTION: {
    ...
    value:
      "Project developed during the C# COMPLETO Programação Orientada a Objetos + Projetos course, simulating the classic chess game. Applying the knowledge of encapsulation, inheritance, polymorphism, enumeration and exception handling.",
  },
...
export const englishLanguageweb = {
  ...
  P_WEB_TITLE: {
    ...
    value: "Web Application Projects",
  },
  P_WEB_HABITS: {
    id: "#web-portfolio-habits",
    value: "Website Project of habits with React",
  },
  P_WEB_HABITS_DESCRIPTION: {
    id: "#web-portfolio-habit-description",
    value:
      "This website was developed during Rocketseat's NLW-Setup week, it was used technologies such as React, TypeScript, Tailwind, Axios, NodeJs, Dayjs and among others, for the complete operation of the application, it is necessary to download the Server repository and run it together.",
  },
  ...
  P_WEB_ANGULAR: {
    ...
    value: "Website Project of recipes with Angular",
  },
  P_WEB_ANGULAR_DESCRIPTION: {
    id: "#web-portfolio-angular-description",
    value:
      "Project developed to put into practice the knowledge acquired during the Angular - The Complete Guide (2023 Edition) course and the deployment is hosted using the firebase tools.",
  },
  ...
  P_WEB_CV: {
    id: "#web-portfolio-cv",
    value: "Website Project with personal CV",
  },
  ...
  P_WEB_CSHARP_DESCRIPTION: {
    ...
    value:
      "Project developed during Udemy's C# COMPLETO Programação Orientada a Objetos + Projetos course, simulating a sales website. The intent was to learn the fundamentals and use the ASP.NET Core MVC.",
  },
  ...
  P_WEB_VUE: {
    ...
    value: "Front-end application development project using VueJS Framework",
  },
  P_WEB_VUE_DESCRIPTION: {
    id: "#web-portfolio-vue-description",
    value:
      "Project developed in the Web Development subject using the VueJS Framework.",
  },
  P_WEB_VUE_DIRECTORY: {
...
export const englishLanguagemobile = {
  ...
  P_MOBILE_HABITS: {
    ...
    value: "Mobile Project of habits with React-Native",
  },
  P_MOBILE_HABITS_DESCRIPTION: {
    id: "#mobile-portfolio-habit-description",
    value:
      "This mobile application was developed during Rocketseat's NLW-Setup week, it was used technologies such as React-Native, TypeScript, Tailwind, Axios, Dayjs and among others, for the complete operation of the application, it is necessary to download the Server repository and run it together.",
  },
